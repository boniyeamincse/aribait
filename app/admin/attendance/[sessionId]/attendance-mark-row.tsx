...
const OPTIONS = [
  { value: "PRESENT", label: "Present", activeClass: "border-emerald-200 bg-emerald-50 text-emerald-700" },
  { value: "LATE", label: "Late", activeClass: "border-amber-200 bg-amber-50 text-amber-700" },
  { value: "ABSENT", label: "Absent", activeClass: "border-red-200 bg-red-50 text-red-700" },
  { value: "EXCUSED", label: "Excused", activeClass: "border-slate-200 bg-slate-50 text-slate-700" },
] as const;

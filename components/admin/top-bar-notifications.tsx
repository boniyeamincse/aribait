...
export function TopBarNotifications({ unreadCount }: { unreadCount: number }) {
  return (
    <Link href="/admin/notifications" className="relative flex h-8 w-8 items-center justify-center rounded-full text-slate-500 hover:bg-slate-100 hover:text-slate-900">
